...
// Consulta para obtener la presentación
$sql = "SELECT 
    id,
    subtitulo,
    titulo,
...
<html lang="es">
  <!-- [Head] start -->
  <head>
    <title>Gestión de Presentación - <?php echo $nombre_sistema; ?></title>
    <!-- [Meta] -->
    <meta charset="utf-8" />
    <meta
      name="viewport"
    ...
    <meta
      name="description"
      content="Sistema CRM para instituciones educativas - Gestión de Presentación"
    />
    <meta
      name="keywords"
      content="CRM, Educación, Gestión Escolar, Presentación, Video, Administración"
    />
    ...
    <!-- Custom styles for presentacion -->
    <style>
      .badge-estado {
        font-size: 0.75rem;
  ...
  <body data-pc-preset="preset-1" data-pc-direction="ltr" data-pc-theme="light">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                <div>
                  ...
                  <small class="text-muted">
                    Administra la sección de presentación con video. 
                    Puedes editar, activar/desactivar y gestionar el contenido.
                  </small>
                </div>
                <div class="d-flex gap-2">
                  <button type="button" class="btn btn-outline-danger btn-sm" onclick="exportarPresentacionPDF()">
    ...
    <img src='../" . htmlspecialchars($row['imagen']) . "' 
         class='presentacion-imagen' alt='Imagen de presentación'
         width='80'>
</td>";
                              ...
                              echo "<td>
                                      <div class='video-descripcion'>" . htmlspecialchars($row['descripcion']) . "</div>
                                    </td>";
                              echo "<td>
                                      <a href='" . htmlspecialchars($row['url_video']) . "' target='_blank' class='link-info'>
                                  ...
                                  echo "<td>
                                      <div class='btn-group btn-group-sm' role='group'>
                                        <button type='button' class='btn btn-outline-primary btn-editar' 
                                                ...
                                                data-url_video='" . htmlspecialchars($row['url_video']) . "'
                          ...
                          echo "<tr><td colspan='8' class='text-center'>No hay presentaciones registradas</td></tr>";
                      }
                      ?>
                    </tbody>
                    <tfoot>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalEditarLabel">Editar Presentación</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>

      <form id="formEditarPresentacion" action="presentacion/editar.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          <div class="row g-3">
            ...
            <!-- URL Video -->
            <div class="col-md-6">
              <label for="edit_url_video" class="form-label">URL del Video *</label>
              <input type="url" class="form-control" id="edit_url_video" name="url_video" required>
              <small class="text-muted">Ejemplo: https://www.youtube.com/watch?v=r9LtOG6pNUw</small>
            </div>
    ...
    $(document).ready(function() {
      ...
      var table = $("#presentacion-table").DataTable({
        "language": {
          "decimal": "",
          "emptyTable": "No hay presentaciones disponibles en la tabla",
      ...
      // Función para exportar presentación a PDF con datos filtrados
      window.exportarPresentacionPDF = function() {
        var tabla = $('#presentacion-table').DataTable();
        var datosVisibles = [];
        ...
        form.method = 'POST';
        form.action = 'reports/generar_pdf_presentacion.php';
        form.target = '_blank';
      ...
      $(document).on('click', '.btn-editar', function() {
        ...
        $('#edit_url_video').val(url_video);
        $('#edit_imagen_actual').val(imagen);
        $('#edit_estado').val(estado);
        
        // Mostrar imagen actual
        if (imagen) {
          $('#current_imagen').html('<strong>Imagen actual:</strong><br><img src="' + imagen + '" class="presentacion-imagen mt-2" alt="Imagen actual">');
        } else {
          $('#current_imagen').html('');
        }
      ...
      $(document).on('click', '.btn-eliminar', function() {
        ...
        Swal.fire({
          title: '¿Estás seguro?',
          text: 'Vas a eliminar la presentación: ' + titulo,
          icon: 'warning',
          ...
          if (result.isConfirmed) {
            $.ajax({
              url: 'presentacion/eliminar.php?id=' + id,
              type: 'GET',
              dataType: 'json',
      ...
      $(document).on('click', '.btn-cambiar-estado', function() {
        ...
        Swal.fire({
          title: '¿Cambiar estado?',
          text: 'La presentación "' + titulo + '" cambiará de ' + estado_actual + ' a ' + nuevo_estado,
          icon: 'question',
          showCancelButton: true,
          ...
          if (result.isConfirmed) {
            $.ajax({
              url: 'presentacion/cambiar_estado.php',
              type: 'POST',
              dataType: 'json',
              data: { 
                id: id,
